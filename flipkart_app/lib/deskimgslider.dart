...
class sliderD extends StatefulWidget {
  const sliderD({Key? key}) : super(key: key);

  @override
  State<sliderD> createState() => _sliderDState();
}

class _sliderDState extends State<sliderD> {
